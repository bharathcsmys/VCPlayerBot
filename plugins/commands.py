...
async def start(client, message):
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/EE_MOVIES'),
            InlineKeyboardButton('🧩 Source', url='https://t.me/EE_MOVIES')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://t.me/EE_MOVIES'),
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/EE_MOVIES'),
